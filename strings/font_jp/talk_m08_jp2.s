...
;   .strn "思っていたのだがな{换页}"
;   .strn "{对话框:右}{文本顺序:01D9}{头像:25}{名字:03:名字}"
;   .strn "お前はオレに{换行}"
;   .strn "仲間とプライドをキズつけられた{换行}"
;   .strn "お前はオレが にくいはずだ{换页}"
;   .strn "{对话框:右}{文本顺序:01DA}{头像:26}{名字:03:名字}"
;   .strn "お前は オレへの{换行}"
...
;   .strn "{对话框:右}{文本顺序:01DD}{头像:25}{名字:03:名字}"
;   .strn "キベンだな{换行}"
;   .strn "そうやって自分を正当化して、{换行}"
;   .strn "ヒーロー気分にひたってるだけだ{换页}"
;   .strn "{对话框:右}{文本顺序:01DE}{头像:26}{名字:03:名字}"
;   .strn "まだ気づいていないんだろう？{换行}"
;   .strn "お前は決してヒーロー{换行}"
;   .strn "なんかじゃないって事を{换页}"
;   .strn "{对话框:左}{文本顺序:01DF}{头像:0A}{名字:雅希:名字}"
;   .strn "…なんですって？{换页}"
;   .strn "{对话框:右}{文本顺序:01E0}{头像:26}{名字:03:名字}"
