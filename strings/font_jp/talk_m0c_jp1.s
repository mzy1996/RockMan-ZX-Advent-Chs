...
talk_m0c_jp1_007:
;原文－－－－－－－－－－－－－－－－－－－－－－
;   .strn "{对话框:下}{对话框:左}{文本顺序:027F}{头像:19}{名字:艾儿:名字}"
;   .strn "悪いけどアタシも、{换行}"
;   .strn "モデルVをわたす気は無いの{换页}"
;   .strn "{对话框:下}{对话框:左}{文本顺序:0280}{头像:18}{名字:艾儿:名字}"
;   .strn "キミがロックマンなら{换行}"
;   .strn "なおさら…ね！{结束}"
;译文－－－－－－－－－－－－－－－－－－－－－－
    .strn "{对话框:下}{对话框:左}{文本顺序:027F}{头像:19}{名字:艾儿:名字}"
...
talk_m0c_jp1_008:
;原文－－－－－－－－－－－－－－－－－－－－－－
;   .strn "{对话框:上}{对话框:右}{文本顺序:0281}{头像:19}{名字:艾儿:名字}"
;   .strn "プロメテたちが言っていた{换行}"
;   .strn "運命のゲーム…{换行}"
;   .strn "まだ続いているのね…{换页}"
;   .strn "{对话框:右}{文本顺序:0282}{头像:19}{名字:艾儿:名字}"
;   .strn "でも…全てのモデルVを{换行}"
...
talk_m0c_jp1_010:
;原文－－－－－－－－－－－－－－－－－－－－－－
;   .strn "{对话框:右}{文本顺序:0284}{头像:1A}{名字:艾儿:名字}"
;   .strn "きゃああっ！{换行}"
;   .strn "な…何…これ…！？{换页}"
...
;   .strn "思い出したのか！？{换行}"
;   .strn "ボクの事も知ってるのか！？{换页}"
;   .strn "{对话框:右}{文本顺序:028B}{头像:17}{名字:艾儿:名字}"
;   .strn "…アタシにも説明してくれない？{换行}"
;   .strn "今、キミとキョウメイした時に、{换行}"
;   .strn "色んなデータが見えたわ{换页}"
;   .strn "{对话框:右}{文本顺序:028C}{头像:17}{名字:艾儿:名字}"
;   .strn "マスター·アルバート…{换行}"
...
talk_m0c_jp1_018:
;原文－－－－－－－－－－－－－－－－－－－－－－
;   .strn "{对话框:右}{文本顺序:0293}{头像:17}{名字:艾儿:名字}"
;   .strn "やめなさい！{换行}"
;   .strn "ライブメタルがかわいそうよ{换行}"
;   .strn "今はそれどころじゃないでしょ？{换页}"
;   .strn "{对话框:右}{文本顺序:0294}{头像:17}{名字:艾儿:名字}"
...
;   .strn "ゴメン、モデルA…{换行}"
;   .strn "先へ進もう{换页}"
;   .strn "{对话框:右}{文本顺序:0296}{头像:16}{名字:艾儿:名字}"
;   .strn "フフッ、すなおなんだね{换页}"
...
talk_m0c_jp1_020:
;原文－－－－－－－－－－－－－－－－－－－－－－
;   .strn "{对话框:右}{文本顺序:0298}{头像:16}{名字:艾儿:名字}"
;   .strn "…アタシにとどめは{换行}"
;   .strn "ささないの？{换页}"
...
;   .strn "ないのか？{换页}"
;   .strn "{对话框:左}{文本顺序:029E}{头像:18}{名字:艾儿:名字}"
;   .strn "アタシもそんな事のために{换行}"
;   .strn "戦ってるんじゃないの{换页}"
;   .strn "{对话框:左}{文本顺序:029F}{头像:19}{名字:艾儿:名字}"
;   .strn "はじめからアタシのねらいは{换行}"
;   .strn "モデルVのハカイ{换页}"
;   .strn "{对话框:左}{文本顺序:02A0}{头像:19}{名字:艾儿:名字}"
;   .strn "ロックマンどうしが戦いあう{换行}"
;   .strn "運命のゲームを止めるためにね{换行}"
;   .strn "…キミ、名前は？{换页}"
;   .strn "{对话框:右}{文本顺序:02A1}{头像:0F}{名字:格雷:名字}"
;   .strn "…え？{换页}"
;   .strn "{对话框:左}{文本顺序:02A2}{头像:18}{名字:艾儿:名字}"
...
;   .strn "コイツはモデルAだ{换行}"
;   .strn "お前たちこそ何者なんだ{换页}"
;   .strn "{对话框:左}{文本顺序:02A4}{头像:18}{名字:艾儿:名字}"
;   .strn "あのねえ…{换行}"
...
talk_m0c_jp1_025:
;原文－－－－－－－－－－－－－－－－－－－－－－
;   .strn "{对话框:左}{文本顺序:02A5}{头像:16}{名字:艾儿:名字}"
;   .strn "アタシの名前はエール{换行}"
;   .strn "この青いライブメタル…{换行}"
;   .strn "モデルXのロックマンよ{换页}"
;   .strn "{对话框:左}{文本顺序:02A6}{头像:16}{名字:艾儿:名字}"
;   .strn "こっちの赤いのはモデルZ{换行}"
;   .strn "これはアタシのじゃなくて、{换行}"
;   .strn "大切なヒトの形見なんだ…{换页}"
;   .strn "{对话框:左}{文本顺序:02A7}{头像:16}{名字:艾儿:名字}"
...
talk_m0c_jp1_026:
;原文－－－－－－－－－－－－－－－－－－－－－－
;   .strn "{对话框:右}{文本顺序:02A8}{头像:17}{名字:艾儿:名字}"
;   .strn "マスター·アルバートに{换行}"
;   .strn "プロメテ、パンドラ…{换行}"
;   .strn "それと四人のロックマン…か{换页}"
;   .strn "{对话框:右}{文本顺序:02A9}{头像:17}{名字:艾儿:名字}"
;   .strn "アタシたちの研究所から{换行}"
...
;   .strn "モデルHたちを追って{换行}"
;   .strn "ここまできた{换页}"
;   .strn "{对话框:右}{文本顺序:02AD}{头像:16}{名字:艾儿:名字}"
...
;   .strn "エールたちはなんで{换行}"
;   .strn "モデルVと戦ってるんだ？{换页}"
;   .strn "{对话框:右}{文本顺序:02AF}{头像:16}{名字:艾儿:名字}"
;   .strn "…それでもよびすてなのね{换行}"
;   .strn "まあ、いいけどさ{换页}"
;   .strn "{对话框:右}{文本顺序:02B0}{头像:16}{名字:艾儿:名字}"
;   .strn "アタシもキミと同じ…{换行}"
;   .strn "わけのわからないうちに{换行}"
;   .strn "戦いにまきこまれてね{换页}"
;   .strn "{对话框:右}{文本顺序:02B1}{头像:17}{名字:艾儿:名字}"
;   .strn "イレギュラーやモデルVとの{换行}"
;   .strn "戦いで大切なヒトをたくさん{换行}"
;   .strn "うしなったの{换页}"
;   .strn "{对话框:左}{文本顺序:02B2}{头像:08}{名字:格雷:名字}"
;   .strn "ふくしゅう…か{换页}"
;   .strn "{对话框:右}{文本顺序:02B3}{头像:16}{名字:艾儿:名字}"
;   .strn "ううん…アタシのように{换行}"
...
talk_m0c_jp1_027:
;原文－－－－－－－－－－－－－－－－－－－－－－
;   .strn "{对话框:右}{文本顺序:02B4}{头像:16}{名字:艾儿:名字}"
;   .strn "だから決めたの{换行}"
;   .strn "運命のゲームを終わらせるために{换行}"
;   .strn "モデルVを全てハカイしようって{换页}"
;   .strn "{对话框:右}{文本顺序:02B5}{头像:16}{名字:艾儿:名字}"
...
talk_m0c_jp1_028:
;原文－－－－－－－－－－－－－－－－－－－－－－
;   .strn "{对话框:右}{文本顺序:02B6}{头像:16}{名字:艾儿:名字}"
;   .strn "キミは自分の正体を知るために{换行}"
;   .strn "戦っているんだよね？{换行}"
;   .strn "…でもわすれないで{换页}"
;   .strn "{对话框:右}{文本顺序:02B7}{头像:16}{名字:艾儿:名字}"
;   .strn "キミの運命はキミだけが{换行}"
;   .strn "決められる{换行}"
;   .strn "正体が何者でもかんけいない{换页}"
;   .strn "{对话框:右}{文本顺序:02B8}{头像:16}{名字:艾儿:名字}"
;   .strn "キミのチカラは、キミだけの{换行}"
;   .strn "未来をつかむチカラなんだよ{换页}"
;   .strn "{对话框:右}{文本顺序:02B9}{头像:16}{名字:艾儿:名字}"
;   .strn "…って、これもアタシの{换行}"
...
;   .strn "ボクの運命…{换行}"
;   .strn "ボクだけの未来…{换页}"
;   .strn "{对话框:右}{文本顺序:02BB}{头像:16}{名字:艾儿:名字}"
;   .strn "そうだ、あなたにコレを{换行}"
;   .strn "あげるわ{结束}"
;译文－－－－－－－－－－－－－－－－－－－－－－
    .strn "{对话框:右}{文本顺序:02B6}{头像:16}{名字:艾儿:名字}"
...
talk_m0c_jp1_029:
;原文－－－－－－－－－－－－－－－－－－－－－－
;   .strn "{对话框:右}{文本顺序:02BC}{头像:16}{名字:艾儿:名字}"
;   .strn "そのキーで行けるエリアに{换行}"
;   .strn "フォルスロイドのハンノウが{换行}"
;   .strn "あるわ{换页}"
;   .strn "{对话框:右}{文本顺序:02BD}{头像:16}{名字:艾儿:名字}"
;   .strn "あとでアタシが調べようと{换行}"
;   .strn "思ってたけど、キミが{换行}"
;   .strn "持っていたほうがよさそうね{换页}"
;   .strn "{对话框:右}{文本顺序:02BE}{头像:16}{名字:艾儿:名字}"
;   .strn "アタシは仲間のところに戻るわ{换行}"
;   .strn "モデルHたちを追わなきゃ{换页}"
;   .strn "{对话框:右}{文本顺序:02BF}{头像:16}{名字:艾儿:名字}"
