...
".\tools\xdelta3\xdelta3-3.1.0-i686.exe" -v -e -f -s ".\baserom_jp_rev0.nds" ".\RockmanZXAdvent_Chs_rev0.nds" ".\release\RockmanZXAdvent_Chs_rev0.xdelta"
".\tools\xdelta3\xdelta3-3.1.0-i686.exe" -v -e -f -s ".\baserom_jp_rev1.nds" ".\RockmanZXAdvent_Chs_rev1.nds" ".\release\RockmanZXAdvent_Chs_rev1.xdelta"
